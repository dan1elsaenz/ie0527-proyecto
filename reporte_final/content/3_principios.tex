...
Cabe aclarar que esta comparación de esquemas se presenta para ofrecer un panorama completo de la investigación; pero la implementación final emplea PCM como formato base y ADPCM como compresión opcional, mientras que $\mu$-law se conserva como mejora futura recomendada y otras opciones como Opus quedan fuera del alcance del proyecto.
...
Estos mecanismos se documentan como parte de la investigación realizada para tener un panorama completo.
De ellos, la solución implementada se apoya en el CRC y la retransmisión automática (ARQ) que ofrece el módulo de radiofrecuencia, complementados con el relleno de los segmentos perdidos para preservar la continuidad de la reproducción, mientras que la paridad y los códigos de Hamming quedan como posibles mejoras futuras.
